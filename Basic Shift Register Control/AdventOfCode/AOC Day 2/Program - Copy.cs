...
namespace AOC_Day_3
{
    class Program
    {
        ...
        static int runIntcode(int noun, int verb)
        {
            try
            {
                ...
                for (int r = 0; r <= intcodeArray.Length;)
                {
                    ...
                    if (intcodeArray[r] == 3)
                    {
                        intcodeArray[intcodeArray[r + 1]] = getInput();
                        r += 2;
                    }
                    if (intcodeArray[r] == 4)
                    {
                        shareOutput(intcodeArray[r + 1]);
                        r += 2;
                    }
        ...
        private static void shareOutput(int v)
        {
