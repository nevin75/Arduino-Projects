...
// variables for a baseline location for the WiiChuck. Compare to this "control" to see if there's any movement.
int baseValColumn;
int baseValRow;
...
//storage variable to send to daisy-chained shift register. Prepped byte for each column gets put here in the recursive loop.
int dataToSend;
