...
{ 
    ...
    //   Serial.print("x or y is different than setup ");
     //  Serial.print("so ledTimes[valColumn][valRow]is");
      // Serial.print(ledTimes[valColumn][valRow]);
     //  Serial.println();
     //  Serial.print ("valColumn =");
      //    Serial.print (valColumn);
      //    Serial.println();
      //     Serial.print ("baseValColumn =");
      //    Serial.print (baseValColumn);
      //    Serial.println();
      // delay (2000);
}
