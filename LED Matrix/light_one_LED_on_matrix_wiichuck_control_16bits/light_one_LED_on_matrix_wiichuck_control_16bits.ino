...
//chuck.begin();
 chuck.update();
  ...
  digitalWrite(latchPin, LOW);
   ...
   bitWrite(columnBitsToSend, 6, 0); // Gives us 000000001
   ...
   bitWrite(columnBitsToSend, 11, 0); // Gives us 000000001
...
shiftOut(dataPin, clockPin, MSBFIRST, columnBitsToSend); // Send the byte to the shift register which passes it to the second shift register
   ...
   bitWrite(rowBitsToSend, 7, 0); // Gives us 00000001
    bitWrite(rowBitsToSend, 8, 1 ); // Adds on to the previous modified bits to give us 00001001
   ...
   bitWrite(rowBitsToSend, 14, 1); // Adds on to the previous modified bits to give us 00001001 The two reds on the short end of the board are shorting.
   bitWrite(rowBitsToSend, 15, 1); // Gives us 00000001
